        ...
        {decoded && (
          <div className="space-y-3">
            ...
            <div>
              ...
              <pre className="w-full p-3 bg-blue-50 border border-blue-100 rounded-xl text-xs font-mono text-gray-700 overflow-x-auto whitespace-pre-wrap">
            ...
            <div>
              ...
              <pre className="w-full p-3 bg-purple-50 border border-purple-100 rounded-xl text-xs font-mono text-gray-700 overflow-x-auto whitespace-pre-wrap">
            ...
            <div>
              ...
              <p className="p-3 bg-gray-50 border border-gray-200 rounded-xl text-xs font-mono text-gray-500 break-all">
                {decoded.signature}
              </p>
            </div>
          </div>
