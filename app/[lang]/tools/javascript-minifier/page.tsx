    ...
    <ToolLayout tool={tool}>
      <div className="max-w-xl mx-auto px-4 space-y-3">
        <div className="flex flex-wrap gap-3">
          {[['Remove comments',rmComments,setRmComments],['Remove whitespace',rmWhitespace,setRmWhitespace],['Remove last semicolons',rmSemicolons,setRmSemicolons]].map(([l,v,s])=>(
        ...
        <div><label className="block text-xs font-medium text-gray-600 mb-1">JavaScript code</label>
