...
export default function JsonToXml() {
  ...
  } catch(e) { if(input.trim()) error = 'Invalid JSON: '+(e as Error).message }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-gray-500 mb-8">Convert JSON data to well-formed XML instantly.</p>
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 mb-6 flex items-center gap-4">
          <label className="text-sm font-medium text-gray-700 whitespace-nowrap">Root element:</label>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 flex flex-col">
            <div className="px-5 py-3 border-b border-gray-200 flex items-center justify-between">
              <span className="font-semibold text-gray-700 text-sm">XML Output</span>
            ...
            <pre className="flex-1 p-5 text-xs font-mono overflow-auto text-gray-700 whitespace-pre-wrap">
              {xml||(error?'⚠ Fix JSON errors first':'Output will appear here...')}
            </pre>
          </div>
        </div>
      </div>
