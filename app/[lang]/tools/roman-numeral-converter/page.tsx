      ...
      <div className="max-w-md mx-auto px-4 space-y-4">
        ...
        {mode==='to'?(
          <div className="space-y-3">
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Integer (1–3999)</label>
            ...
            <div className="text-center bg-amber-50 rounded-xl py-5 border border-amber-100">
              <p className="text-xs text-amber-600 mb-1">Roman Numeral</p>
              <p className="text-4xl font-bold text-amber-800 font-serif tracking-widest">{toResult}</p>
            </div>
          </div>
        ):(
          <div className="space-y-3">
            <div><label className="block text-sm font-medium text-gray-700 mb-1">Roman numeral</label>
            ...
            <div className="text-center bg-blue-50 rounded-xl py-5 border border-blue-100">
              <p className="text-xs text-blue-600 mb-1">Integer</p>
              <p className="text-4xl font-bold text-blue-800 font-mono">{fromResult??'Invalid'}</p>
            </div>
          </div>
        )}
        <div>
        ...
        <div className="bg-gray-50 rounded-xl p-3 text-xs text-gray-600 space-y-0.5">
          <p className="font-medium text-gray-700 mb-1">Roman numeral reference</p>
