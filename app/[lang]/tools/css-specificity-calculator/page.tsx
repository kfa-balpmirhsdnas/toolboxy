  ...
  return (
    <ToolLayout tool={tool}>
      <div className="max-w-lg mx-auto px-4 space-y-4">
        <div><label className="block text-sm font-medium text-gray-700 mb-1">CSS Selectors (one per line)</label>
        ...
        <div><p className="text-xs text-gray-500 mb-2">Examples:</p>
