  ...
  return (
    <ToolLayout tool={tool}>
      <div className="max-w-2xl mx-auto px-4">
        ...
        <p className="text-gray-500 mb-8">Calculate compound interest growth with regular monthly contributions</p>
        ...
        {P>0&&t>0&&(
          <>
            ...
            <div className="mt-4 bg-white rounded-2xl border border-gray-200 overflow-hidden">
              <div className="px-4 py-3 border-b border-gray-100 font-semibold text-gray-800">Year-by-Year Growth</div>
              <div className="overflow-auto max-h-64">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50"><tr>{['Year','Balance','Contributed','Interest'].map(h=><th key={h} className="px-4 py-2 text-left text-gray-500 font-medium">{h}</th>)}</tr></thead>
                  <tbody>
                    {breakdown.map(r=>(
