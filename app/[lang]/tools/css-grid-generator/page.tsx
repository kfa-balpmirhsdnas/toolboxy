    ...
    <ToolLayout tool={tool}>
      <div className="max-w-2xl mx-auto px-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <label className="flex flex-col gap-1 text-sm text-gray-700">Columns
          ...
          <label className="flex flex-col gap-1 text-sm text-gray-700">Rows
          ...
          <label className="flex flex-col gap-1 text-sm text-gray-700">Column Gap
          ...
          <label className="flex flex-col gap-1 text-sm text-gray-700">Row Gap
