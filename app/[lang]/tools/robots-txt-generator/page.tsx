    ...
    <ToolLayout tool={tool} lang={params.lang}>
      <div className="space-y-4">
        <div className="flex gap-2">
          {([['all', 'rtg_allow'], ['none', 'rtg_block']] as ['all' | 'none', string][]).map(([id, label]) => (
        ...
        {policy === 'all' && (
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('rtg_disallow')}</label>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">{t('rtg_sitemap')}</label>
