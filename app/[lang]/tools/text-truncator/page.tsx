  ...
  return (
    <ToolLayout tool={tool} lang={params.lang}>
      <div className="space-y-4">
        <textarea value={input} onChange={e=>{setInput(e.target.value);track()}} rows={4} placeholder="Text to truncate..."
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <div>
            <label className="block text-xs font-medium text-gray-600 mb-1">Ellipsis</label>
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            <label className="text-xs font-medium text-gray-600">Result ({output.length} chars)</label>
