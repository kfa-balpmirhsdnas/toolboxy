      ...
      <div data-game-stage className="relative max-w-md mx-auto space-y-5 text-center">
        ...
        {finished ? (
          <>
            ...
            <button onClick={stage.begin} className="px-6 py-2.5 bg-brand-600 text-white font-semibold rounded-xl hover:bg-brand-700 inline-flex items-center justify-center gap-1.5"><ToolIcon name="refresh" className="w-4 h-4" />{t('quiz_again')}</button>
          </>
        ) : (
          <>
