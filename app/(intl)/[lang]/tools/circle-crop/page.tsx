        ...
        {!src ? (
          ...
          <>
            ...
            <div className="flex gap-2 justify-center">
              <button onClick={download} disabled={!result} className="px-5 py-2 bg-brand-600 text-white text-sm font-semibold rounded-xl hover:bg-brand-700 disabled:opacity-50 inline-flex items-center justify-center gap-1.5"><ToolIcon name="download" className="w-4 h-4" />{t('ati_downloadpng')}</button>
