...
function errorKey(code: string): string {
  ...
  if (code === 'auth/wrong-password') return 'err_wrong_password'
  if (code === 'auth/too-many-requests') return 'err_too_many'
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">{t('welcome_back')}</h1>
            ...
            <form onSubmit={handleEmail} className="space-y-4">
              ...
              <div>
                <div className="flex justify-between mb-1">
                  ...
                  <Link href={`/${params.lang}/forgot-password`} className="text-xs text-brand-600 hover:underline">{t('forgot')}</Link>
                </div>
