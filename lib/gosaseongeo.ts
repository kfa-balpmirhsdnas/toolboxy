...
export const IDIOMS: Idiom[] = [
  ...
  {"id":"gs0005","hanja":"過猶不及","reading":"과유불급","len":4,"lit":"지나침은 미치지 못함과 같음","fig":"정도를 지나침은 모자람과 같다","origin":"공자가 자장과 자하 중 누가 나으냐는 물음에 '지나침은 미치지 못함과 같다'고 답한 데서 나온 말","source":"논어","example":"운동도 과유불급이라 지나치면 몸을 해친다.","syn":[],"reviewed":true},
  {"id":"gs0006","hanja":"群鷄一鶴","reading":"군계일학","len":4,"lit":"닭 무리 속의 한 마리 학","fig":"평범한 사람들 가운데 뛰어난 한 사람","origin":"혜소(嵇紹)가 사람들 틈에 섞여도 닭 무리 속의 학처럼 의젓하고 돋보였다는 평에서 나온 말","source":"진서","example":"수많은 지원자 중에서 그녀는 단연 군계일학이었다.","syn":["囊中之錐"],"reviewed":true},
  ...
  {"id":"gs0009","hanja":"囊中之錐","reading":"낭중지추","len":4,"lit":"주머니 속의 송곳","fig":"뛰어난 재능은 저절로 드러남","origin":"평원군의 식객 모수가 '송곳을 주머니에 넣으면 끝이 삐져나오듯 뛰어난 이는 드러난다'며 자신을 천거한 고사","source":"사기","example":"실력이 있으면 낭중지추처럼 언젠가 드러나기 마련이다.","syn":["群鷄一鶴"],"reviewed":true},
  ...
  {"id":"gs0012","hanja":"大器晩成","reading":"대기만성","len":4,"lit":"큰 그릇은 늦게 이루어짐","fig":"큰 인물은 늦게 성공함","origin":"노자 도덕경의 '큰 그릇은 늦게 이루어진다'는 구절에서 나온 말","source":"노자","example":"그는 마흔에 빛을 본 대기만성형 배우다.","syn":[],"reviewed":true},
  {"id":"gs0013","hanja":"同病相憐","reading":"동병상련","len":4,"lit":"같은 병을 앓는 이끼리 가엾게 여김","fig":"처지가 비슷한 사람끼리 서로 동정함","origin":"오자서가 아버지를 잃은 같은 처지의 백비를 거두며, 같은 병을 앓는 이끼리 서로 가엾게 여긴다고 한 데서 나온 말","source":"오월춘추","example":"같은 처지라 동병상련의 마음으로 그를 도왔다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0018","hanja":"明鏡止水","reading":"명경지수","len":4,"lit":"맑은 거울과 고요한 물","fig":"잡념 없이 맑고 고요한 마음","origin":"장자가 욕심 없는 고요한 마음을 맑은 거울과 잔잔한 물에 빗댄 데서 나온 말","source":"장자","example":"그는 명경지수 같은 마음으로 결정을 내렸다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0025","hanja":"不恥下問","reading":"불치하문","len":4,"lit":"아랫사람에게 묻기를 부끄러워하지 않음","fig":"모르는 것을 묻는 것을 부끄러워하지 않음","origin":"공자가 공문자의 시호 '문(文)'을 풀이하며, 아랫사람에게 묻기를 부끄러워하지 않았다고 한 데서 나온 말","source":"논어","example":"불치하문의 자세로 후배에게도 배운다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0031","hanja":"首丘初心","reading":"수구초심","len":4,"lit":"여우가 죽을 때 머리를 고향 언덕으로 둠","fig":"고향을 그리워하는 마음","origin":"여우도 죽을 때면 머리를 살던 언덕으로 둔다는 데서, 근본과 고향을 잊지 않는 마음을 이르는 말","source":"예기","example":"나이 들수록 수구초심으로 고향이 그립다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0033","hanja":"脣亡齒寒","reading":"순망치한","len":4,"lit":"입술이 없으면 이가 시림","fig":"서로 의지하던 한쪽이 망하면 다른 쪽도 위태로움","origin":"진나라가 우나라에 길을 빌려 괵나라를 치려 하자, 궁지기가 '입술이 없으면 이가 시리다'며 만류한 고사","source":"춘추좌씨전","example":"협력사가 무너지면 우리도 위태로우니 순망치한이다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0037","hanja":"緣木求魚","reading":"연목구어","len":4,"lit":"나무에 올라 물고기를 구함","fig":"불가능한 일을 무리하게 하려 함","origin":"맹자가 제선왕에게 무력으로 천하를 얻으려는 것은 나무에 올라 물고기를 구하는 격이라고 한 데서 나온 말","source":"맹자","example":"준비 없이 성공을 바라는 건 연목구어다.","syn":[],"reviewed":true},
  {"id":"gs0038","hanja":"五里霧中","reading":"오리무중","len":4,"lit":"오 리에 걸친 안개 속","fig":"일의 갈피를 전혀 잡을 수 없음","origin":"후한의 장해가 도술로 오 리에 걸친 짙은 안개를 일으켰다는 데서, 갈피를 잡을 수 없음을 이르는 말","source":"후한서","example":"사건은 단서조차 없이 오리무중이다.","syn":[],"reviewed":true},
  {"id":"gs0039","hanja":"吳越同舟","reading":"오월동주","len":4,"lit":"오나라와 월나라가 한 배를 탐","fig":"원수 사이라도 위급할 땐 서로 협력함","origin":"손자병법에서, 사이가 나쁜 오나라와 월나라 사람도 한 배를 타고 풍랑을 만나면 서로 돕는다고 한 데서 나온 말","source":"손자","example":"경쟁사지만 위기 앞에선 오월동주로 손잡았다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0041","hanja":"溫故知新","reading":"온고지신","len":4,"lit":"옛것을 익혀 새것을 앎","fig":"옛것을 바탕으로 새 지식을 얻음","origin":"공자가 '옛것을 익혀 새것을 알면 스승이 될 만하다'고 한 데서 나온 말","source":"논어","example":"고전을 읽으며 온고지신의 지혜를 얻는다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0046","hanja":"有備無患","reading":"유비무환","len":4,"lit":"준비가 있으면 근심이 없음","fig":"미리 대비하면 걱정할 것이 없다","origin":"서경에서 '미리 준비가 되어 있으면 근심할 일이 없다'고 한 데서 나온 말","source":"서경","example":"유비무환이라고, 미리 대비해 두자.","syn":[],"reviewed":true},
  ...
  {"id":"gs0053","hanja":"戰戰兢兢","reading":"전전긍긍","len":4,"lit":"몹시 두려워 조심함","fig":"잘못될까 봐 매우 두려워하고 조심함","origin":"시경의 '깊은 못가에 서듯, 살얼음을 밟듯 두려워 떤다'는 구절에서 나온 말","source":"시경","example":"들킬까 봐 전전긍긍하며 지냈다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0055","hanja":"切磋琢磨","reading":"절차탁마","len":4,"lit":"옥돌을 자르고 갈고 쪼고 닦음","fig":"학문과 덕을 끊임없이 갈고닦음","origin":"시경에서 옥돌을 자르고 갈고 쪼고 다듬듯, 학문과 덕을 끊임없이 닦는다고 한 데서 나온 말","source":"시경","example":"동료들과 절차탁마하며 실력을 키웠다.","syn":[],"reviewed":true},
  {"id":"gs0056","hanja":"井底之蛙","reading":"정저지와","len":4,"lit":"우물 안 개구리","fig":"견문이 좁아 넓은 세상을 모름","origin":"장자에서 '우물 안 개구리에게는 바다를 말해도 알지 못한다'고 한 데서 나온 말","source":"장자","example":"넓은 세상을 보니 그동안 정저지와였음을 깨달았다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0060","hanja":"竹馬故友","reading":"죽마고우","len":4,"lit":"대말을 타고 놀던 옛 벗","fig":"어릴 때부터 함께 자란 오랜 친구","origin":"진나라 환온이 은호를 두고 '어릴 적 함께 죽마를 타고 놀던 벗'이라 한 데서 나온 말","source":"진서","example":"그와는 삼십 년 지기 죽마고우다.","syn":["刎頸之交"],"reviewed":true},
  {"id":"gs0061","hanja":"衆寡不敵","reading":"중과부적","len":4,"lit":"적은 수로 많은 수를 대적하지 못함","fig":"수가 적으면 많은 쪽을 이길 수 없다","origin":"맹자가 '적은 수로는 많은 수를 대적할 수 없다'고 한 데서 나온 말","source":"맹자","example":"용감히 맞섰으나 중과부적이었다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0064","hanja":"靑出於藍","reading":"청출어람","len":4,"lit":"쪽에서 나온 푸른빛이 쪽보다 더 푸름","fig":"제자나 후배가 스승·선배보다 나음","origin":"순자의 '푸른색은 쪽풀에서 나왔지만 쪽보다 더 푸르다'는 구절에서, 제자가 스승보다 나음을 이르는 말","source":"순자","example":"제자가 스승을 뛰어넘었으니 청출어람이다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0069","hanja":"破竹之勢","reading":"파죽지세","len":4,"lit":"대나무를 쪼개는 기세","fig":"막을 수 없을 만큼 거침없이 나아가는 기세","origin":"진나라 두예가 오나라를 칠 때 '대나무를 쪼개는 기세'라 한 데서 나온 말","source":"진서","example":"우리 팀은 파죽지세로 결승에 올랐다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0073","hanja":"浩然之氣","reading":"호연지기","len":4,"lit":"넓고 큰 기운","fig":"거침없이 떳떳하고 도덕적인 기상","origin":"맹자가 공손추에게 천지에 가득 찬 지극히 크고 굳센 도덕적 기운을 호연지기라 설명한 데서 나온 말","source":"맹자","example":"산에 올라 호연지기를 길렀다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0081","hanja":"易地思之","reading":"역지사지","len":4,"lit":"처지를 바꾸어 생각함","fig":"상대의 입장에서 헤아려 봄","origin":"맹자의 '처지를 바꾸어 놓으면 누구나 똑같이 행동한다(易地則皆然)'는 말에서 비롯된 성어","source":"맹자","example":"싸우기 전에 역지사지로 한 번 생각해 보자.","syn":[],"reviewed":true},
  ...
  {"id":"gs0103","hanja":"大同小異","reading":"대동소이","len":4,"lit":"크게는 같고 작게만 다름","fig":"거의 비슷하고 큰 차이가 없음","origin":"장자에서 '크게 보면 같고 작게 보면 다르다'고 한 데서 나온 말","source":"장자","example":"후보들 공약이 대동소이해서 고르기 어렵다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0105","hanja":"日就月將","reading":"일취월장","len":4,"lit":"날로 나아가고 달로 발전함","fig":"실력이 빠르게 늘어 감","origin":"시경의 '날로 나아가고 달로 진보한다'는 구절에서 나온 말","source":"시경","example":"꾸준히 연습하더니 실력이 일취월장했다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0112","hanja":"難兄難弟","reading":"난형난제","len":4,"lit":"형이라 하기도 아우라 하기도 어려움","fig":"둘이 비슷해 우열을 가리기 어려움","origin":"세설신어에서 진씨 형제의 우열을 가리기 어려워 '형이라 하기도 아우라 하기도 어렵다'고 한 데서 나온 말","source":"세설신어","example":"두 작품 모두 뛰어나 난형난제다.","syn":["莫上莫下"],"reviewed":true},
  ...
  {"id":"gs0117","hanja":"自暴自棄","reading":"자포자기","len":4,"lit":"스스로 해치고 스스로 버림","fig":"절망에 빠져 자신을 돌보지 않고 마구 행동함","origin":"맹자가 '스스로를 해치는 자(自暴)와 스스로를 버리는 자(自棄)'를 경계한 데서 나온 말","source":"맹자","example":"한 번 실패했다고 자포자기하면 안 된다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0166","hanja":"信賞必罰","reading":"신상필벌","len":4,"lit":"상은 믿음 있게, 벌은 반드시","fig":"공이 있으면 반드시 상을 주고 죄가 있으면 반드시 벌함","origin":"한비자에서 '공이 있으면 반드시 상을 주고, 죄가 있으면 반드시 벌한다'고 한 데서 나온 말","source":"한비자","example":"신상필벌이 분명해야 조직이 산다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0186","hanja":"亡羊補牢","reading":"망양보뢰","len":4,"lit":"양을 잃고 우리를 고침","fig":"일이 잘못된 뒤에 늦게라도 대비함","origin":"전국책의 '양을 잃은 뒤에라도 우리를 고치면 늦지 않다'는 말에서, 실패 후의 대비를 이르는 말","source":"전국책","example":"사고 후에야 점검하니 망양보뢰인 셈이다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0194","hanja":"莫逆之友","reading":"막역지우","len":4,"lit":"거스름이 없는 벗","fig":"허물없이 아주 친한 친구","origin":"장자에서 마음에 서로 거스름이 없어(莫逆) 벗이 된 이들의 이야기에서 나온 말","source":"장자","example":"그와는 어릴 적부터 막역지우다.","syn":["竹馬故友","水魚之交"],"reviewed":true},
  {"id":"gs0195","hanja":"見利思義","reading":"견리사의","len":4,"lit":"이익을 보면 의로움을 생각함","fig":"이익 앞에서 옳음을 먼저 헤아림","origin":"공자가 '이익을 보면 먼저 옳음을 생각하라'고 한 데서 나온 말","source":"논어","example":"견리사의를 새겨 부정한 돈은 멀리한다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0227","hanja":"自強不息","reading":"자강불식","len":4,"lit":"스스로 힘써 쉬지 않음","fig":"스스로 강해지려고 끊임없이 노력함","origin":"주역의 '군자는 하늘의 운행처럼 스스로 힘쓰며 쉬지 않는다'는 구절에서 나온 말","source":"주역","example":"자강불식의 자세로 매일 단련했다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0234","hanja":"曲學阿世","reading":"곡학아세","len":4,"lit":"학문을 굽혀 세상에 아첨함","fig":"바른 학문을 굽혀 권력이나 세속에 영합함","origin":"사기에서 원고생이 공손홍에게 '학문을 굽혀 세상에 아첨하지 말라'고 경계한 데서 나온 말","source":"사기","example":"곡학아세하지 말고 소신을 지켜라.","syn":[],"reviewed":true},
  ...
  {"id":"gs0240","hanja":"居安思危","reading":"거안사위","len":4,"lit":"편안할 때 위태로움을 생각함","fig":"평안할 때에도 위기에 대비함","origin":"춘추좌씨전의 '편안할 때에 위태로움을 미리 생각하라'는 말에서 나온 말","source":"춘추좌씨전","example":"거안사위라고, 잘될 때 더 조심해야 한다.","syn":["有備無患"],"reviewed":true},
  ...
  {"id":"gs0300","hanja":"格物致知","reading":"격물치지","len":4,"lit":"사물을 궁구해 앎에 이름","fig":"사물의 이치를 끝까지 따져 참된 앎에 이름","origin":"대학에서 '사물의 이치를 끝까지 따져 앎에 이른다'고 한 데서 나온 말","source":"대학","example":"격물치지의 자세로 깊이 파고들었다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0335","hanja":"發憤忘食","reading":"발분망식","len":4,"lit":"분발하여 먹는 것도 잊음","fig":"끼니를 잊을 만큼 어떤 일에 열중함","origin":"공자가 자신을 '한번 분발하면 끼니도 잊고 몰두하는 사람'이라 한 데서 나온 말","source":"논어","example":"발분망식하며 연구에 몰두했다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0344","hanja":"狡兔三窟","reading":"교토삼굴","len":4,"lit":"영리한 토끼는 굴이 셋","fig":"위기에 대비해 여러 대비책을 마련해 둠","origin":"전국책에서 풍훤이 맹상군에게 '꾀 있는 토끼는 굴을 셋 파 둔다'며 대비를 권한 데서 나온 말","source":"전국책","example":"교토삼굴이라고, 여러 대비책을 세워 뒀다.","syn":["有備無患"],"reviewed":true},
  ...
  {"id":"gs0349","hanja":"簞食瓢飮","reading":"단사표음","len":4,"lit":"대그릇 밥과 표주박 물","fig":"청빈하고 소박한 생활","origin":"공자가 제자 안회를 두고 '한 그릇 밥과 한 바가지 물로도 즐거움을 잃지 않는다'고 칭찬한 데서 나온 말","source":"논어","example":"단사표음에도 마음은 넉넉했다.","syn":["安貧樂道"],"reviewed":true},
  ...
  {"id":"gs0352","hanja":"道聽塗說","reading":"도청도설","len":4,"lit":"길에서 듣고 길에서 말함","fig":"근거 없이 떠도는 뜬소문","origin":"공자가 '길에서 들은 것을 그대로 길에서 옮기는 것은 덕을 버리는 일'이라 한 데서 나온 말","source":"논어","example":"도청도설에 휘둘리지 말자.","syn":[],"reviewed":true},
  {"id":"gs0353","hanja":"登高自卑","reading":"등고자비","len":4,"lit":"높이 오르려면 낮은 데서부터","fig":"무슨 일이든 차례와 기초를 밟아야 함","origin":"중용의 '높은 곳에 오르려면 반드시 낮은 곳에서 시작한다'는 말에서 나온 말","source":"중용","example":"등고자비라고, 기초부터 다지자.","syn":[],"reviewed":true},
  ...
  {"id":"gs0365","hanja":"如履薄氷","reading":"여리박빙","len":4,"lit":"살얼음을 밟는 듯","fig":"몹시 위태롭고 조심스러움","origin":"시경의 '깊은 못가에 서듯, 살얼음을 밟듯 조심한다'는 구절에서 나온 말","source":"시경","example":"여리박빙의 심정으로 일을 처리했다.","syn":["累卵之危"],"reviewed":true},
  ...
  {"id":"gs0367","hanja":"寤寐不忘","reading":"오매불망","len":4,"lit":"자나 깨나 잊지 못함","fig":"늘 마음에 두어 잊지 못함","origin":"시경 관저의 '자나 깨나 잊지 못한다'는 구절에서 나온 말","source":"시경","example":"고향을 오매불망 그리워했다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0373","hanja":"輾轉反側","reading":"전전반측","len":4,"lit":"이리저리 뒤척임","fig":"걱정이나 생각으로 잠을 이루지 못함","origin":"시경 관저의 '그리워 잠 못 이루고 이리저리 뒤척인다'는 구절에서 나온 말","source":"시경","example":"걱정에 전전반측 밤을 새웠다.","syn":[],"reviewed":true},
  ...
  {"id":"gs0376","hanja":"千慮一失","reading":"천려일실","len":4,"lit":"천 번 생각에 한 번 실수","fig":"지혜로운 사람도 가끔 실수가 있음","origin":"사기에서 '지혜로운 이도 천 번 생각에 한 번은 실수가 있다'고 한 데서 나온 말","source":"사기","example":"천려일실로 사소한 걸 놓쳤다.","syn":[],"reviewed":true},
