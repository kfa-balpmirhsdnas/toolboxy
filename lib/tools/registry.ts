...
export const SINGLE_APP_TOOLS = new Set([
  ...
  'video-player', 'calculator', 'music-player',
])
...
export const HIDDEN_CATEGORIES: ReadonlySet<ToolCategory> = new Set<ToolCategory>([])
...
export const TOOLS: ToolMeta[] = [
  ...
  {slug:'three-kingdoms-quiz',category:'three-kingdoms',also:['game'],added:'2026-07-11',phase:1,isPro:false,isNew:true,tags:['삼국지 퀴즈','삼국지 상식 테스트','삼국지 문제','삼국지 시험','three kingdoms quiz','three kingdoms trivia','romance of the three kingdoms quiz','三国志クイズ','三国志 検定','三国志 問題'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'three-kingdoms-idioms',category:'three-kingdoms',also:['classics'],added:'2026-07-11',phase:1,isPro:false,isNew:true,tags:['삼국지 고사성어','삼고초려 뜻','도원결의 뜻','고사성어 유래','삼국지 사자성어','three kingdoms idioms','chinese idioms origin','三国志 故事成語','故事成語 由来','三顧の礼 意味'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'three-kingdoms-test',category:'three-kingdoms',also:['funny'],added:'2026-07-11',phase:1,isPro:false,isNew:true,tags:['삼국지 인물 테스트','삼국지 테스트','성격 테스트','나와 닮은 삼국지 장수','조조 유형','제갈량 유형','three kingdoms personality test','which three kingdoms character are you','personality quiz','三国志 性格診断','三国志 診断','武将診断'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'lottery-number-generator',category:'random',added:'2026-06-29',phase:1,isPro:false,isNew:true,tags:['로또 번호 생성기','로또 번호 추천','로또 6/45','복권 번호','파워볼 번호','lottery number generator','lotto number generator','powerball generator','random lottery numbers','ロト番号生成','宝くじ番号'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'music-player',category:'audio',added:'2026-07-05',phase:1,isPro:false,isNew:true,tags:['음악 플레이어','mp3 플레이어','음악 재생','백그라운드 재생','잠금화면 재생','재생목록','music player','mp3 player','audio player','background music','offline music player','ミュージックプレーヤー','音楽プレーヤー','mp3プレーヤー'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'zip-files',category:'file',added:'2026-06-26',phase:1,isPro:false,isNew:true,tags:['zip 만들기','파일 묶기','zip files','create zip','compress files'],maxFileSizeMB:{free:100,pro:500} },
  {slug:'unzip',category:'file',added:'2026-06-26',phase:1,isPro:false,isNew:true,tags:['압축 해제','zip 파일 열기','unzip','extract zip','open zip'],maxFileSizeMB:{free:100,pro:500} },
