...
export const TOOLS: ToolMeta[] = [
  ...
  {slug:'caesar-cipher',category:'developer',phase:1,isPro:false,isNew:true,tags:['cipher','encryption','encode'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'checksum-generator',category:'developer',phase:1,isPro:false,isNew:true,tags:['checksum','hash','md5'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'color-codes-converter',category:'developer',phase:1,isPro:false,isNew:true,tags:['color','convert','hex','rgb'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'color-converter',category:'developer',phase:1,isPro:false,isNew:true,tags:['color','convert','hex','hsl'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'color-gradient-generator',category:'developer',phase:1,isPro:false,isNew:true,tags:['color','gradient','css'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'color-scheme-generator',category:'developer',phase:1,isPro:false,isNew:true,tags:['color','scheme','palette'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'css-box-model-visualizer',category:'developer',phase:1,isPro:false,isNew:true,tags:['css','box-model','layout'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'css-flexbox-playground',category:'developer',phase:1,isPro:false,isNew:true,tags:['css','flexbox','layout'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'html-color-picker',category:'developer',phase:1,isPro:false,isNew:true,tags:['color','html','picker'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'jwt-decoder',category:'developer',phase:1,isPro:false,isNew:true,tags:['jwt','token','decode'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'mime-type-checker',category:'developer',phase:1,isPro:false,isNew:true,tags:['mime','file','type'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'open-graph-preview',category:'developer',phase:1,isPro:false,isNew:true,tags:['og','seo','preview'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'text-encryptor',category:'developer',phase:1,isPro:false,isNew:true,tags:['encrypt','cipher','security'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'slug-to-title',category:'text',phase:1,isPro:false,isNew:true,tags:['slug','title','convert'],maxFileSizeMB:{free:0,pro:0} },
  ...
  {slug:'password-generator',category:'utility',phase:1,isPro:false,isNew:true,tags:['password','generate','secure'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'pdf-to-text',category:'utility',phase:1,isPro:false,isNew:true,tags:['pdf','text','extract'],maxFileSizeMB:{free:0,pro:0} },
  {slug:'qr-generator',category:'utility',phase:1,isPro:false,isNew:true,tags:['qr','code','generate'],maxFileSizeMB:{free:0,pro:0} },
