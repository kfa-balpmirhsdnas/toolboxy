...
export const TOOLS: ToolMeta[] = [
  ...
  // ââ DEVELOPER âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
export const CATEGORY_META: Record<ToolCategory, { label: string; icon: string; color: string }> = {
  pdf:       { label: 'PDF',            icon: 'ð', color: 'red'    },
  image:     { label: 'Image',          icon: 'ð¼',  color: 'purple' },
  video:     { label: 'Video',          icon: 'ð¬', color: 'pink'   },
  audio:     { label: 'Audio',          icon: 'ð', color: 'yellow' },
  text:      { label: 'Text',           icon: 'ð', color: 'green'  },
  developer: { label: 'Developer',      icon: 'ð»', color: 'blue'   },
  file:      { label: 'File',           icon: 'ð', color: 'orange' },
  utility:   { label: 'Utility',        icon: 'ð§', color: 'teal'   },
}
