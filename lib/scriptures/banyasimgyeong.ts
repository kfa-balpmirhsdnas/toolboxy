...
export const BANYASIMGYEONG: SutraLine[] = [
  { order: 1, section: 1, sectionKo: '제목', sectionHanja: '摩訶般若波羅蜜多心經', type: '제목',
    hanja: '摩訶般若波羅蜜多心經', reading: '마하반야바라밀다심경', readingJa: 'まかはんにゃはらみたしんぎょう',
    translation: '마하반야바라밀다심경 (위대한 지혜로 피안에 이르는 핵심 경전)', translationJa: '摩訶般若波羅蜜多心経（大いなる智慧で彼岸に至る、心髄の経）', repeat: 1, note: '' },
