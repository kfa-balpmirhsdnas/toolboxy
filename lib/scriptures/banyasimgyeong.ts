...
// a transliteration and is left untranslated. Sections follow the common passage
// division (제목 → 관자재보살 → 색즉시공 → …).

import type { SutraLine } from './types'

export const BANYASIMGYEONG: SutraLine[] = [
  { order: 1, section: 1, sectionKo: '마하반야바라밀다심경', sectionHanja: '摩訶般若波羅蜜多心經', type: '제목',
    hanja: '摩訶般若波羅蜜多心經', reading: '마하반야바라밀다심경', readingJa: 'まかはんにゃはらみたしんぎょう',
    translation: '위대한 지혜로 깨달음의 언덕에 이르는 가르침의 핵심을 담은 경전', translationJa: '大いなる智慧で悟りの彼岸に至る、教えの心髄を収めた経', repeat: 1, note: '' },

  { order: 2, section: 2, sectionKo: '관자재보살', sectionHanja: '觀自在菩薩', type: '본문',
  ...
  { order: 3, section: 2, sectionKo: '관자재보살', sectionHanja: '觀自在菩薩', type: '본문',
  ...
  { order: 4, section: 3, sectionKo: '색즉시공', sectionHanja: '色卽是空', type: '본문',
  ...
  { order: 5, section: 3, sectionKo: '색즉시공', sectionHanja: '色卽是空', type: '본문',
  ...
  { order: 6, section: 4, sectionKo: '제법공상', sectionHanja: '諸法空相', type: '본문',
  ...
  { order: 7, section: 4, sectionKo: '제법공상', sectionHanja: '諸法空相', type: '본문',
  ...
  { order: 8, section: 5, sectionKo: '공중무색', sectionHanja: '空中無色', type: '본문',
  ...
  { order: 9, section: 5, sectionKo: '공중무색', sectionHanja: '空中無色', type: '본문',
  ...
  { order: 10, section: 5, sectionKo: '공중무색', sectionHanja: '空中無色', type: '본문',
  ...
  { order: 11, section: 6, sectionKo: '무무명', sectionHanja: '無無明', type: '본문',
  ...
  { order: 12, section: 6, sectionKo: '무무명', sectionHanja: '無無明', type: '본문',
  ...
  { order: 13, section: 7, sectionKo: '보리살타', sectionHanja: '菩提薩埵', type: '본문',
  ...
  { order: 14, section: 7, sectionKo: '보리살타', sectionHanja: '菩提薩埵', type: '본문',
  ...
  { order: 15, section: 8, sectionKo: '삼세제불', sectionHanja: '三世諸佛', type: '본문',
  ...
  { order: 16, section: 9, sectionKo: '대신주', sectionHanja: '大神呪', type: '본문',
  ...
  { order: 17, section: 9, sectionKo: '대신주', sectionHanja: '大神呪', type: '본문',
  ...
  { order: 18, section: 10, sectionKo: '반야심경 진언', sectionHanja: '般若心經 眞言', type: '진언',
  ...
  { order: 19, section: 10, sectionKo: '반야심경 진언', sectionHanja: '般若心經 眞言', type: '진언',
